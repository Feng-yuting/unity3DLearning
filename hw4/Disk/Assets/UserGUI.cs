...
public class UserGUI : MonoBehaviour {
    ...
    void OnGUI () {
        if (game == 0) { // playing
            GUI.Label(new Rect(Screen.width / 2 - 180, Screen.height / 10, 100, 50), "Round: " + round, LabelStyle1);
            GUI.Label(new Rect(Screen.width / 2 - 30, Screen.height / 10, 100, 50), "Time: " + timeLeft, LabelStyle1);
            GUI.Label(new Rect(Screen.width / 2 + 120, Screen.height / 10, 100, 50), "Score: " + score, LabelStyle1);
